                ...
                props: {
                    decorations: ({ doc, selection }) => {
                        ...
                        const addColumnRight = (pos) => {
                            ...
                            measurePerformance('addColumnAfter', () => this.editor.chain().focus(pos).addColumnAfter().run());
                        };

                        const addRowBelow = (pos) => {
                            this.editor.commands.setTextSelection(pos);
                            measurePerformance('addRowAfter', () => this.editor.chain().focus(pos).addRowAfter().run());
                        };
